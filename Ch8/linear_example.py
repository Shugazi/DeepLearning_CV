...
# randomly initialie our weight matrix and bias vector -- in a
# *real* training and classifciation task, these parameters would
# be *learned* by our model, but for the sake of this example,
# lets use random values
...
# compute the output scores by taking the dor product between the
# weight matrix and image pixels, followed by adding tin the bias
